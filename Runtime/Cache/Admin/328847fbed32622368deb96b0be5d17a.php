...
<body>
	...
	<div class="main-title">
		<h2><?php echo ($info['id']?'编辑':'新增'); ?>品牌</h2>
	</div>
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">品牌名称<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="name" value="<?php echo ((isset($info["name"]) && ($info["name"] !== ""))?($info["name"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">品牌Logo<span class="check-tips"></span></label>
            <div class="controls">
                    <input type="file" id="upload_picture_logo">
                    <input type="hidden" name="logo" id="cover_id_logo" value="<?php echo ($info['logo']); ?>"/>
                    
                    <div class="upload-img-box">
                        <?php if(!empty($info['logo'])): ?><div class="upload-pre-item"><img src="<?php echo (get_cover($info['logo'],'path')); ?>"/></div><?php endif; ?>
                    </div>
                    
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">品牌描述<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="describe" value="<?php echo ((isset($info["describe"]) && ($info["describe"] !== ""))?($info["describe"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
