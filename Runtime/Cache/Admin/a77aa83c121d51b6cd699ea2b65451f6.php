...
<head>
    ...
    <link href="/OneShop/Public/favicon.ico" type="image/x-icon" rel="shortcut icon">
    <link rel="stylesheet" type="text/css" href="/OneShop/Public/Admin/css/base.css" media="all">
    <link rel="stylesheet" type="text/css" href="/OneShop/Public/Admin/css/common.css" media="all">
    <link rel="stylesheet" type="text/css" href="/OneShop/Public/Admin/css/module.css">
    <link rel="stylesheet" type="text/css" href="/OneShop/Public/Admin/css/style.css" media="all">
	<link rel="stylesheet" type="text/css" href="/OneShop/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css" media="all">
     <!--[if lt IE 9]>
    <script type="text/javascript" src="/OneShop/Public/static/jquery-1.10.2.min.js"></script>
    <![endif]--><!--[if gte IE 9]><!-->
    <script type="text/javascript" src="/OneShop/Public/static/jquery-2.0.3.min.js"></script>
    <script type="text/javascript" src="/OneShop/Public/Admin/js/jquery.mousewheel.js"></script>
    <!--<![endif]-->
...
<body>
    ...
    <div class="header">
        <!-- Logo -->
        <span class="logo"><img src="/OneShop/Public/Admin/images/logo.png"/></span>
    ...
    (function(){
        var ThinkPHP = window.Think = {
            "ROOT"   : "/OneShop", //当前网站地址
            "APP"    : "/OneShop/admin.php?s=", //当前项目地址
            "PUBLIC" : "/OneShop/Public", //项目公共目录地址
    ...
    <script type="text/javascript" src="/OneShop/Public/static/think.js"></script>
    <script type="text/javascript" src="/OneShop/Public/Admin/js/common.js"></script>
    <script type="text/javascript">
        +function(){
