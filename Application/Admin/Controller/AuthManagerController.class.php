...
class AuthManagerController extends AdminController{
    ...
    public function index(){
        ...
        if(!$is_admin){
            $data['user_id']=UID;
            $this->assign( 'guanli',$is_admin);
        }
        $list = $this->lists('AuthGroup',$data,'id asc');
    ...
    public function createGroup(){
        ...
        $this->assign('user_id',UID)->display('editgroup');
    }
    ...
    public function editGroup(){
        ...
        $this->assign('user_id',UID)->display();
    }
    ...
    public function access(){
        $this->updateRules();
        $auth_group = M('AuthGroup')->where( array('status'=>array('egt','0'),'user_id'=>UID,'module'=>'admin','type'=>AuthGroupModel::TYPE_ADMIN) )
                                    ->getfield('id,id,title,rules');
        $guanli=is_administrator();
        $node_list = $guanli? $this->returnNodes() :  $this->returnUserNodes();
...
//        dump($node_list);die;
        ...
        $this->assign('guanli', $guanli)->display('managergroup');
    }
    ...
    public function group(){
        $uid            =   I('uid');
        $auth_groups    =   D('AuthGroup')->getGroups(array('user_id'=>UID));
